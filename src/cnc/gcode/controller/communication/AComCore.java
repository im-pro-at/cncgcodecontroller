...
abstract class AComCore {
    ...
    private final IResivedLines resivedlines;
    private final IDisconnect disconnect;

    public AComCore(IResivedLines resivedlines, IDisconnect disconnect) {
    ...
    public static AComCore openPort(IResivedLines resivedlines, IDisconnect disconnect, String name, int speed) throws Exception{
        if(name.equals("SIM"))
